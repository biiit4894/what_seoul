...
public class UserDescription {
    ...
    public static final String GET_USER_LIST_SUCCESS = """
            회원 리스트 조회 성공
            - message : 회원 정보 리스트 조회 성공
            """;

    public static final String GET_USER_DETAIL_SUCCESS = """
    ...
    public static final String UPDATE_USER_INFO_SUCCESS = """
            회원 정보 수정 성공
            - message : 회원 정보 수정 성공
            """;
    ...
    public static final String WITHDRAW_USER = """
            ...
            - 계정 비밀번호를 정확히 입력한 경우, soft delete 방식으로 회원을 탈퇴 처리하여 deleted_at 값을 갱신합니다.\s
            - 탈퇴처리 완료 직후, 현재 사용자 인증 정보를 제거하고 세션을 무효화합니다.\s
            - 매일 1회, 스케줄러를 통해 탈퇴 처리한지 30일 이상의 시간이 지난 유저 정보를 확인한 후 hard delete 합니다.
            - 탈퇴처리된 계정으로 다시 로그인할 수 없습니다.
            """;

    public static final String WITHDRAW_USER_SUCCESS = """
            회원 탈퇴 성공
            - message : 회원 탈퇴 성공
            """;

    public static final String FIND_USERID_SUCCESS = """
            아이디 찾기 성공
            - message : 아이디 찾기 성공
            """;

    public static final String FIND_PASSWORD_SUCCESS = """
            비밀번호 찾기 성공
            - message : 비밀번호 찾기 성공
            """;
