...
public class ReqCreateAdminDTO {
    ...
    @Schema(description = "생성하려는 관리자 계정의 유저 아이디", example = "test")
    ...
    @Schema(description = "생성하려는 관리자 계정의 비밀번호", example = "%123abc")
    ...
    @Schema(description = "생성하려는 관리자 계정의 이메일 주소", example = "test@test.com")
    ...
    @Schema(description = "생성하려는 관리자 계정의 닉네임", example = "관리자")
