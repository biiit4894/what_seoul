...
public class CitydataController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "실시간 인구 현황 데이터 조회 성공")
    })
    ...
    @CommonErrorResponses
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "실시간 날씨 현황 데이터 조회 성공")
    })
    ...
    @CommonErrorResponses
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "문화행사 데이터 조회 성공")
    })
